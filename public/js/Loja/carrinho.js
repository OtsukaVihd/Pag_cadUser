...
//Retorna carrinho
    ...
    botaoGravar.addEventListener('click', gravarPedido);
    ...
    function montarCarrinho(){
        if(listaProdutos.length > 0){
            ...
            for(let i = 0; i < listaProdutos.length; i++){
                ...
                html += `<tr>
                            <td><img src="${produto.imagem}" width="100" height="150"></td>
                            <td>${produto.nome}</td>
                            ...
                            <td>
                                <div style="display: flex;">
                                    ...
                                    <input id="qtdeProduto-${produto.id}" class="form-control qtdeProduto" style="width: 75px" data-id="${produto.id}" value="${produto.quantidade}" type="number">
            ...
            html += `<div>
                        <h3 style="text-align:end">Total do pedido: <span id="totalCarrinho">R$${parseFloat(valorTotal).toFixed(2)}</span></h3>
                    </div>            
            `
    ...
    function aumentar(){
        ...
        let id = this.dataset.id;
        let quantidade = document.getElementById('qtdeProduto-' + id).value;
        if (quantidade < 999)
            quantidade++;
