...
class UsuarioController {
    ...
    async cadastrarView(req, res) {
        ...
        res.render('usuario/cadastrar', {listaPerfil: listaPerfil});
    }
    ...
    async alterarView(req, res){
        ...
        if(req.params.id != undefined){
            ...
            res.render('usuario/alterar', {usuario: usuario, listaPerfil: listaPerfil});
        }
        else{
            res.redirect('/');
        }
    ...
    async excluir(req, res) {
        if(req.body.id != ""){
            ...
            if (result == true)
                ...
                res.send({ok: false, msg: "Erro ao excluir o usuário!"})
        }
        else{
    ...
    async alterar(req, res) {
        if(req.body.id > 0 && req.body.nome != ''  && req.body.email != '' && req.body.perfil != '0' && req.body.senha != "") {
