...
class ProdutoController {
    ...
    async cadastrarProduto(req, res){
        ...
        req.body.preco > '0' && req.file != null) {
            let produto = new ProdutoModel(0, req.body.codigo, req.body.nome, req.body.quantidade, req.body.categoria, req.body.marca, "", "", req.body.preco, req.file.filename);
        ...
        if(req.body.codigo != "" && req.body.nome != "" && req.body.quantidade != "" && req.body.quantidade  != '0' && req.body.marca != '0' && req.body.categoria  != '0'  && req.body.preco > '0') {
            ...
            if(req.file != undefined){
                ...
                if(produtoOld.possuiImagem == true){
                    //realiza a deleção da imagem no diretorio
    ...
    async obterProduto(req, res){
        if(req.params.id != null){
            ...
            res.send({ok: false, msg: 'Parâmetro Inválido!'});
        }
